pipeline {
  ...
  stages {
    ...
    stage('Test') {
      steps {
        sh 'docker run --rm -w /home/jenkins --user jenkins --mount type=bind,source=${WORKSPACE}/lsp-dev-nightly-test,target=/home/jenkins/lsp-dev-nightly-test jenkins bin/lsp-test.sh'
      }
    }
